...
refreshList = () => {
	...
	.get("http://127.0.0.1:8000/api/api/rooms/")
...
handleSubmit = (item) => {
	...
	axios
		.put(`http://127.0.0.1:8000/api/api/rooms/${item.id}/`, item)
		.then((res) => this.refreshList());
	return;
	}
	// if new post to submit
	axios
	.post("http://127.0.0.1:8000/api/api/rooms/", item)
	.then((res) => this.refreshList());
};
...
handleDelete = (item) => {
	...
	axios
	.delete(`http://127.0.0.1:8000/api/api/rooms/${item.id}/`)
	.then((res) => this.refreshList());
};
